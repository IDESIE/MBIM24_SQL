...
*/
select id, spaceid, assetidentifier, externalidentifier, serialnumber
from components
...
where facilityid = 1
     and name like '%con%'
     AND (expectedlife is null or warrantystarton is null));
/* 25
...
*/
select name, installedon, warrantystarton 
from components 
where facilityid = 1
...
from component_types
where facilityid = 1 
and warrantyperiod is not null; 
